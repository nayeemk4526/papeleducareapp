...
const CourseCard = ({ course }: { course: Course }) => (
  ...
  >
    ...
    <div className="p-4">
      ...
      <p className="text-xs text-muted-foreground mb-3">{course.instructor?.name || "শিক্ষক"}</p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-4 md:gap-6 overflow-hidden">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="min-w-[260px] md:min-w-[280px] bg-card rounded-2xl border border-border/50 animate-pulse">
